...
----
dependencies {
    implementation 'io.jumpco.open:kfsm-jvm:1.6.0'
}
----
...
----
dependencies {
    implementation 'io.jumpco.open:kfsm-js:1.6.0'
}
----
...
----
dependencies {
    implementation 'io.jumpco.open:kfsm-linuxX64:1.6.0'
}
----
...
----
dependencies {
    implementation 'io.jumpco.open:kfsm-mingwX64:1.6.0'
}
----
...
----
dependencies {
    implementation 'io.jumpco.open:kfsm-macosX64:1.6.0'
}
----
