...
Guarded transitions has a guard expression that will be evaluated to allow execution of transition.

Automatic transitions are associated with states and have no events. Automatic transitions will be executed if the specific state apply after the exit action.
