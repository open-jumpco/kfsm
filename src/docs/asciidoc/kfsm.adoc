...
We will further place COINS state in a named state map to illustrate how these can be composed to isolate or group behaviour.
...
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/io/jumpco/open/kfsm/example/PayingTurnstileFsmTests.kt[tag=test]
----
...
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/io/jumpco/open/kfsm/example/PacketReaderTests.kt[tag=context]
----
...
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/io/jumpco/open/kfsm/example/PacketReaderTests.kt[tag=states-events]
----
...
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/io/jumpco/open/kfsm/example/PacketReaderTests.kt[tag=packaged]
----
...
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/io/jumpco/open/kfsm/example/PacketReaderTests.kt[tag=tests]
----
