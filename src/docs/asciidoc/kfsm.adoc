...
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/TurnstileTypes.kt[tag=states-events]
----

==== Packaged definition and execution
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/TurnstileTypes.kt[tag=packaged]
----
...
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/SecureTurnstile.kt[tag=fsm]
----
...
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/ImmutableLockFSM.kt[tag=context]
----
...
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/ImmutableLockFSM.kt[tag=definition]
----
...
[source,kotlin]
----
include::../../commonTest/kotlin/ImmutableLockFSM.kt[tag=test]
----
...
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/TimeoutSecureTurnstile.kt[tag=context]
----
...
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/TimeoutSecureTurnstile.kt[tag=states-events]
----

==== State machine definition packaged
[source,kotlin,numbered]
----
include::../../commonTest/kotlin/TimeoutSecureTurnstile.kt[tag=fsm]
----

==== Test
[source,kotlin,numbered]
----
include::../../jvmTest/kotlin/TimeoutSecureTurnstileTests.kt[tag=test]
----
