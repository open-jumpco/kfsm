...
----
dependencies {
    implementation 'io.jumpco.open:kfsm-wasm32:1.0.1'
}
----
...
----
dependencies {
    implementation 'io.jumpco.open:kfsm-linuxX64:1.0.1'
}
----
...
----
dependencies {
    implementation 'io.jumpco.open:kfsm-mingwX64:1.0.1'
}
----
...
----
dependencies {
    implementation 'io.jumpco.open:kfsm-macosX64:1.0.1'
}
----
== Operation
