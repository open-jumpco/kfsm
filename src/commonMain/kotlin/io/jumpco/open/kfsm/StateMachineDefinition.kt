...
class StateMachineDefinition<S : Enum<S>, E : Enum<E>, C>(
    internal val deriveInitialState: StateQuery<C, S>?,
    internal val transitionRules: Map<Pair<S, E>, TransitionRules<S, E, C>>,
    internal val defaultTransitions: Map<E, DefaultTransition<E, S, C>>,
    internal val entryActions: Map<S, DefaultChangeAction<C, S>>,
    internal val exitActions: Map<S, DefaultChangeAction<C, S>>,
    internal val defaultActions: Map<S, DefaultStateAction<C, S, E>>,
    internal var globalDefault: DefaultStateAction<C, S, E>?,
    internal var defaultEntryAction: DefaultChangeAction<C, S>?,
    internal var defaultExitAction: DefaultChangeAction<C, S>?
) {
    /**
